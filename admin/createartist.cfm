...
<!---	<cfif getArtists.CurrentRow MOD 2 eq 0> 
	...
	<cfelse> --->
		<cfset Middle = Middle & '<div class="columns"><div class="column"><div class="container has-text-centered"><img src="images/Thumb_#getArtists.ArtistID#_#getRepresentative.ImageID#.jpg" width=100%  border=0 alt="#getArtists.Name#" HSPACE=5 VSPACE=5></div></div><div class="column is-two-thirds"><a href="artist_#getArtists.ArtistID#.html"><b>#getArtists.Name#</b>#CR#</a><br>#getArtists.Blurb#</div></div>'>
	<!--- </cfif> --->
</cfloop>
...
<cfloop query="getArtists">
	...
	<cfloop query="getArt">				
	    <cfset Middle = Middle & "<div class='column is-one-third has-text-centered'><a href='Image_#ThisArtistID#_#getArt.ArtworkID#.html'><img src='images/thumb_#ThisArtistID#_#getArt.ArtworkID#.jpg' width=100% hspace=20 border=0 alt='#getArt.Name#' align='top'></a><br><FONT FACE='Arial,Helvetica' size=2><a href='Image_#ThisArtistID#_#getArt.ArtworkID#.html'>#getArt.Name#</a><br>#getArt.Size#<br>#getArt.Price#</font></div>">		
	</cfloop>
